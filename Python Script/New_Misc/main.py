...
if __name__ == '__main__':
    ...
    fact13 = ps.read_csv("FactSet_Position_202212124_130.csv") 
    crd13 = ps.read_csv("CRD_Position_202212124_130.csv")
    gwp13 = ps.read_csv("GWP_Position_202212124_130.csv")
    
    print("Current number of partitions:", fact13.getNumPartitions())
    print("Current number of partitions:", crd13.getNumPartitions())
    print("Current number of partitions:", gwp13.getNumPartitions())

    # Repartition the DataFrame into a larger number of smaller partitions
    # num_partitions = 10  # Set the desired number of partitions
